  ...
  return (
    <section id="hero" ref={ref} className="relative min-h-[100svh] overflow-hidden bg-[#FBFBFC]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        ...
        {/* أعمدة قامات الصاعدة */}
        <div className="absolute bottom-0 left-[4%] hidden items-end gap-3 md:flex">
      ...
      <motion.div
        style={{ y, opacity }}
        className="container-q relative flex min-h-[100svh] items-center justify-between pt-32 pb-24"
      >
        {/* النصوص والعناصر على اليمين */}
        <div className="max-w-2xl">
          ...
          <h1 className="mt-8 text-[clamp(2.6rem,7.4vw,5.5rem)] font-bold leading-[1.08] tracking-tight text-[#15274E]">
            {line.split(" ").map((w, i) => (
        ...
        {/* صعود اللوقو المستقل والواضح 100% من الأسفل */}
        <motion.div
          initial={{ y: 180, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1.2, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}
          className="hidden shrink-0 lg:flex items-center justify-center pl-10"
        >
          <img
            src="/logo.png"
            alt="قامات"
            className="h-[360px] w-auto object-contain drop-shadow-sm select-none"
          />
        </motion.div>
