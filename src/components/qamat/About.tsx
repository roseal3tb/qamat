        ...
        <div className="mx-auto mt-14 max-w-3xl">
          <Reveal>
            <p className="text-center text-base leading-loose text-foreground/85 md:text-lg">
              قامات هي مبادرة نوعية تهدف إلى بناء وتمكين الكفاءات الشابة من خلال
              شراكات استراتيجية مع جهات رائدة لإنشاء برامج متخصصة في المجالات
              المهنية الواعدة.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <p className="text-center text-base leading-loose text-muted-foreground">
              تهدف المبادرة إلى تطوير المهارات وتعزيز الجاهزية المهنية ونقل
              الخبرات العملية للمشاركين عبر تجارب تدريبية وتطبيقية تسهم في إعداد
              جيل من الكفاءات القادرة على صناعة الأثر والمنافسة في سوق العمل.
            </p>
          </Reveal>
        </div>
